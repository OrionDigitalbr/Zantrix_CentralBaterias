...
export function WhatsappSection() {
  return (
    <section className="relative py-16 min-h-[750px] md:min-h-0">
      <div className="absolute inset-0 z-0">
        <div className="hidden md:block h-full w-full">
          <Image
            src="/images/home/Zantrix-GrupoCentral_Banner_PC_WhatsApp---1920x448.jpg"
            alt="Compre pelo WhatsApp - Grupo Central"
            fill
        ...
        <div className="md:hidden h-full w-full">
          <Image
            src="/images/home/Zantrix-GrupoCentral_Banner_Celular_WhatsApp.jpg"
            alt="Compre pelo WhatsApp - Grupo Central - Mobile"
            fill
            className="object-cover"
            sizes="100vw"
            priority
      ...
      <div className="container mx-auto px-4 relative z-10 flex flex-col min-h-[750px] md:min-h-0 h-full">
        ...
        <div className="flex-1 flex flex-col justify-end md:justify-start">
          <div className="max-w-xl w-full pb-8 md:pb-0">
            <h2 className="text-3xl font-bold text-white mb-4">COMPRE PELO WHATSAPP</h2>
            <p className="text-white text-lg mb-6">
              Atendimento rápido e personalizado. Envie sua dúvida ou pedido diretamente para nossa equipe e receba um
