...
export function SafetyItems() {
  return (
    <section className="relative py-16 min-h-[800px] md:min-h-0">
      <div className="absolute inset-0 z-0">
        <div className="hidden md:block h-full w-full">
          <Image
          src="/images/home/Zantrix-GrupoCentral_Banner_PC_Seguranca---1920x448.jpg"
          alt="Itens de Seguranca"
          fill
      ...
      <div className="md:hidden h-full w-full">
        <Image
          src="/images/home/Zantrix-GrupoCentral_Banner_Celular_Seguranca.jpg"
          alt="Itens de Seguranca - Mobile"
          fill
          className="object-cover"
          sizes="100vw"
          priority
    ...
    <div className="container mx-auto px-4 relative z-10 flex flex-col min-h-[800px] md:min-h-0 h-full">
      ...
      <div className="flex-1 flex flex-col justify-end md:justify-start">
        <div className="max-w-xl w-full pb-8 md:pb-0">
            <h2 className="text-3xl font-bold text-black mb-4">ITENS DE SEGURANÇA</h2>
            <p className="text-black text-lg mb-6">
              Oferecemos uma linha completa de produtos para aumentar a segurança dos motoristas e veículos, garantindo
              mais tranquilidade nas estradas.
            </p>
            ...
            <li className="flex items-center">
              ...
              Proteção para o motorista e veículo
            </li>
            <li className="flex items-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
